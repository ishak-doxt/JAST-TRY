...
while attemps < 12345677901:
    ...
    if username == 'Lya' and password == 'Ma':
...
os.system('espeak -a 300 " TEEEEEROOO,   NAAAAAM,  K,HOOOO,"')
NameX =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m:\33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  LYAA MAA,  Tools"')
os.system('xdg-open https://www.facebook.com/profile.php?id=100076839015736 ')
def banner():
	os.system("clear")
	print (f"""____  ____  ____    ____      _     ___    __  
`MM' 6MMMMb\`MM'    `MM'     dM.    `MM    d'  @
 MM 6M'    ` MM      MM     ,MMb     MM   d'   
 MM MM       MM      MM     d'YM.    MM  d'    
 MM YM.      MM      MM    ,P `Mb    MM d'     
 MM  YMMMMb  MMMMMMMMMM    d'  YM.   MMd'      
 MM      `Mb MM      MM   ,P   `Mb   MMYM.     
 MM       MM MM      MM   d'    YM.  MM YM.    
 MM       MM MM      MM  ,MMMMMMMMb  MM  YM.   
 MM L    ,M9 MM      MM  d'      YM. MM   YM.  
_MM_MYMMMM9 _MM_    _MM_dM_     _dMM_MM_   YM._
                                               
\33[1;92m╔
\33[1;92m║ DEVELOPER    \33[1;91m ❂     \x1b[38;5;48mLYA MA..!\33[1;92m               
\33[1;92m║ FACEBOOK \33[1;91m     ❂     \x1b[38;5;208m ISHAK....!\33[1;92m              
\33[1;92m║ GITHUB     \33[1;91m   ❂    \x1b[38;5;47m Ishak-bro\33[1;92m                    
\33[1;92m║ TEAM    \33[1;91m      ❂  \x1b[38;5;47m  ishak-team\33[1;92m                    
\33[1;92m║ VERSION   \33[1;91m    ❂     \x1b[38;5;48m10.9\33[1;92m                            
...
\33[1;92m"
\33[1;92m╔
\33[1;92m║ MAMA : SAMARPAN\33[1;92m  ║
\33[1;92m"\033[1;31m""")
def login():
	banner()
...
def crack_file():
	os.system('clear')
	banner()
	os.system('espeak -a 300 " FILE DAAL YAHA PAR"')
...
def passwrd():
	...
	print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mHAREK 5MIN PE FLIGHT ON KAR MCHOOD")
	TUTULj(f'\033[0;97m===============================================')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[ISHAK-X] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
